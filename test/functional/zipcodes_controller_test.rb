...
class ZipcodesControllerTest < ActionController::TestCase
  ...
  test "should create zipcode" do
    assert_difference('Zipcode.count') do
      post :create, zipcode: { codigo: @zipcode.codigo, provincia: @zipcode.provincia, sector: @zipcode.sector }
    end
  ...
  test "should update zipcode" do
    put :update, id: @zipcode, zipcode: { codigo: @zipcode.codigo, provincia: @zipcode.provincia, sector: @zipcode.sector }
    assert_redirected_to zipcode_path(assigns(:zipcode))
  end
